...
\providecommand{\engkeywords}[1]{\textbf{\textit{Keywords: }} #1}
%%%%
...
read_chunk("scripts/prueba.R")
@

<<Resumen, child='capitulos/01_Resumen.Rnw'>>=
@

<<Abstract, child='capitulos/02_Abstract.Rnw'>>=
@
