...
\begin{teorema}[Desigualdad de Hoeffding~\citep{10.2307/2282952}]
...
\improvement{Meter los dos resultados anteriores}



    Notaremos $\mu_i = \mathbb{E}[X_i]$. By (1.7) and (1.8),
...
\improvement{Aquí falta bastante}
